...
ActiveRecord::Schema.define(:version => 20121017111000) do
  ...
  create_table "events", :force => true do |t|
    ...
    t.date     "start_date",         :default => '2012-10-25'
    t.date     "end_date",           :default => '2012-10-25'
    t.time     "start_date_time",    :default => '2000-01-01 10:49:42'
    t.time     "end_date_time",      :default => '2000-01-01 10:49:42'
